...
function CardN({itam}) {
  ...
  <div className="card-body items-center text-center ">
    <h2 className="card-title">{itam.title}</h2>
    <div className="bg-color-eoc367 h-30">
        <span className
        ="text-decoration: line-through">{itam.oldPrice}</span>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <span className="font-bold">{itam.newPrice}</span>
    </div>
